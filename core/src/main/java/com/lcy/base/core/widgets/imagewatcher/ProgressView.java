...
public class ProgressView extends View {
    ...
    static class MaterialProgressDrawable extends AnimationDrawable {
        ...
        private static class Ring {
            ...
            /**
             * Set the color the progress spinner alternates between.
             *
             * @param colors Array of integers describing the color. Must be non-<code>null</code>.
             */
            public void setColors(int[] colors) {
                mColors = colors;
                // if color are reset, make sure to reset the color index as well
                setColorIndex(0);
            }
             ...
             * wrap back to the beginning of color.
             */
