...
public class PersistentCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = "call_cookie";        //cookie使用prefs保存
    ...
    public PersistentCookieStore() {
        cookiePrefs = CoreApplication.Companion.instance().getSharedPreferences(COOKIE_PREFS, Context.MODE_PRIVATE);
        cookies = new HashMap<>();
