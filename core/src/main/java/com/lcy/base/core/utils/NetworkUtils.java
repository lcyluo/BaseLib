...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        CoreApplication.instance().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) CoreApplication.instance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) CoreApplication.instance().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) CoreApplication.instance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) CoreApplication.instance().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        CoreApplication.instance().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        CoreApplication.instance().unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
        }
