...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) BaseApplication.instance.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseApplication.instance.getSystemService(WIFI_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) BaseApplication.instance.getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
