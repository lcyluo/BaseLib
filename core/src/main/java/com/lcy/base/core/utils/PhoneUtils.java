...
public final class PhoneUtils {
    ...
    public static boolean dial(final String phoneNumber) {
        ...
        if (isIntentAvailable(intent)) {
            CoreApplication.Companion.instance().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            return true;
        }
        return false;
    }
    ...
    private static TelephonyManager getTelephonyManager() {
        return (TelephonyManager) CoreApplication.Companion.instance().getSystemService(Context.TELEPHONY_SERVICE);
    }

    private static boolean isIntentAvailable(final Intent intent) {
        return CoreApplication.Companion.instance()
                .getPackageManager()
